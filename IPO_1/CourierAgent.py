...
class CourierAgent:
    def __init__(self, name):
        ...
        #self.loadCapacity = loadCapacity #грузоподъемность
    ...
    def getInfo(self):
        ...
        st= [self.name, (str(round(self.speed, 2))+"км/ч"), (str(round(self.сarryingCapacity, 2))+"кг"), self.initialLocation, (str(self.workingDay)+"ч")]
        return st
